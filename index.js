    ...
    return __c(
        ...
        [
            ...
            __c(
                'div',
                {
                    style:'height:100px;width:100%;background:green;margin-top:20px;border-radius:10px;background:#171717;box-shadow:2px 2px 5px #000;font-size:14px;color:#fff;display:flex;align-items:center;padding:10px 15px;font-family:Helvetica, Arial, Verdana, sans-serif;cursor:pointer;'
                },
                [
