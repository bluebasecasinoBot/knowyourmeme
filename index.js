...
__SYD.imageOne = () =>{
    return __c(
        'div',
        {
            style:'height:calc((100vw - 30px) * 0.33);width:100%;margin-top:30px;background-image:url("./img1.jpg");background-size:contain;background-position:0 center;background-repeat:no-repeat;'
        },[],{
            // genericStyle:['bg_fit']
        }
    )
...
__SYD.imageTwo = () =>{
    return __c(
        'div',
        {
            style:'height:calc((100vw - 30px) * 0.28);width:100%;margin-top:30px;background-image:url("./img2.jpg");background-size:contain;background-position:0 center;background-repeat:no-repeat;'
        }
    )
}
